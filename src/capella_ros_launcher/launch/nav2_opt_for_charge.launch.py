...
def generate_launch_description():
    ...
    astra_cam_dir = get_package_share_directory("astra_camera")
    aruco_ros_dir = get_package_share_directory("aruco_ros")
    ...
    map_yaml_path = LaunchConfiguration('map', default = os.path.join(dsfbot_nav2_dir, 'map', 'fifth_floor.yaml'))
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([dsfbot_nav2_dir, '/launch','/bringup_opt_for_charge.launch.py']),
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([astra_cam_dir, '/launch','/dabai_dcw.launch.py']),
        ),
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([aruco_ros_dir, '/launch','/single.launch.py']),
        ),
