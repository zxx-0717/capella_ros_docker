...
def generate_launch_description():
    ...
    if 'ROBOT_VERSION' in os.environ:
        if os.environ.get('ROBOT_VERSION') == 'bainan_1':
            param_file_name = 'dsf_nav2_opt_pc.yaml'
        elif os.environ.get('ROBOT_VERSION') == 'bainan_2':
            param_file_name = 'dsf_nav2_2.yaml'
    else:
        param_file_name = 'dsf_nav2_opt_pc.yaml'

    map_yaml_path = LaunchConfiguration('map', default = os.path.join(dsfbot_nav2_dir, 'map', 'cheku20230216.yaml'))
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([dsfbot_nav2_dir, '/launch','/bringup_opt_pc.launch.py']),
        ),
        ...
        Node(
            ...
            executable='coverage_waypoint_follower',
            name='coverage_waypoint_follower',
            output='screen'),
    ])
