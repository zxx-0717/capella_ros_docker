...
def generate_launch_description():
    ...
    lidar_correct_dir = get_package_share_directory('capella_ros_lidar_correction')
    ...
    #lidar_correct_node
    lidar_correct_node = Node(
       package = "capella_ros_lidar_correction",
       executable = "lidar_correct_node",
       name = "lidar_correct_node",
       parameters = [os.path.join(lidar_correct_dir, 'config', 'lidar_undistortion.yaml')],)
    ...
    launch_description = LaunchDescription([serial_port_node, robot_state_publisher_node, joint_state_publisher_node, 
                                            ...
                                            plicp_odom_node, ekf_filter_node, lidar_correct_node])
    # launch_description = LaunchDescription([serial_port_node, robot_state_publisher_node, joint_state_publisher_node, 
    #                                         apply_calib_node, imu_filter_node, dsf_base_node,
